import { SET_COLLECTS, PUSH_COLLECTS, SET_COLLECT, SET_CURRENT_COLLECT_ID, ADD_PAGE,
    SET_COUNT, HAS_MORE, HAS_UPDATE, HAS_UPDATE_RESET, SET_COLLECT_NAME, SET_COLLECT_DESCRIPTION,
    SET_ARTICLES } from '../mutation-types'
